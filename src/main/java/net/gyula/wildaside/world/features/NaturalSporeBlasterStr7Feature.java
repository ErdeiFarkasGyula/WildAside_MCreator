...
public class NaturalSporeBlasterStr7Feature extends Feature<NoneFeatureConfiguration> {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:natural_spore_blaster_str_7", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:natural_spore_blaster_str_7", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
