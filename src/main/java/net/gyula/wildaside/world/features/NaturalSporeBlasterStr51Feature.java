...
public class NaturalSporeBlasterStr51Feature extends Feature<NoneFeatureConfiguration> {
	public static NaturalSporeBlasterStr51Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new NaturalSporeBlasterStr51Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:natural_spore_blaster_str_51", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:natural_spore_blaster_str_51", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public NaturalSporeBlasterStr51Feature() {
