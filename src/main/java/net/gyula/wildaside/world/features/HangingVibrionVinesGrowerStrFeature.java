...
public class HangingVibrionVinesGrowerStrFeature extends Feature<NoneFeatureConfiguration> {
	public static HangingVibrionVinesGrowerStrFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new HangingVibrionVinesGrowerStrFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:hanging_vibrion_vines_grower_str", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:hanging_vibrion_vines_grower_str", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public HangingVibrionVinesGrowerStrFeature() {
