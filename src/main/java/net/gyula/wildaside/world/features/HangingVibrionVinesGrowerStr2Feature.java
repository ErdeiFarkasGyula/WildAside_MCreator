...
public class HangingVibrionVinesGrowerStr2Feature extends Feature<NoneFeatureConfiguration> {
	public static HangingVibrionVinesGrowerStr2Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new HangingVibrionVinesGrowerStr2Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:hanging_vibrion_vines_grower_str_2", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:hanging_vibrion_vines_grower_str_2", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public HangingVibrionVinesGrowerStr2Feature() {
