...
public class NaturalSporeBlasterStrFeature extends Feature<NoneFeatureConfiguration> {
	public static NaturalSporeBlasterStrFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new NaturalSporeBlasterStrFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:natural_spore_blaster_str", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:natural_spore_blaster_str", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public NaturalSporeBlasterStrFeature() {
