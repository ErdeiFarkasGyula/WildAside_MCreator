...
public class TallBirchTreeStr1Feature extends Feature<NoneFeatureConfiguration> {
	public static TallBirchTreeStr1Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new TallBirchTreeStr1Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:tall_birch_tree_str_1", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:tall_birch_tree_str_1", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public TallBirchTreeStr1Feature() {
