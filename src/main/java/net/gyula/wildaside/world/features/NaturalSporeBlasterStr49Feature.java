...
public class NaturalSporeBlasterStr49Feature extends Feature<NoneFeatureConfiguration> {
	public static NaturalSporeBlasterStr49Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new NaturalSporeBlasterStr49Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:natural_spore_blaster_str_49", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:natural_spore_blaster_str_49", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public NaturalSporeBlasterStr49Feature() {
