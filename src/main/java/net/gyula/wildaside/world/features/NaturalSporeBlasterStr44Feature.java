...
import net.gyula.wildaside.procedures.NaturalSporeBlasterAdditionalGenerationConditionProcedure;
...
public class NaturalSporeBlasterStr44Feature extends Feature<NoneFeatureConfiguration> {
	public static NaturalSporeBlasterStr44Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new NaturalSporeBlasterStr44Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:natural_spore_blaster_str_44", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:natural_spore_blaster_str_44", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public NaturalSporeBlasterStr44Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if ((context.random().nextInt(1000000) + 1) <= 1000000) {
			...
			for (int a = 0; a < count; a++) {
				...
				int y = spawnTo.getY();
				int z = spawnTo.getZ();
				if (!NaturalSporeBlasterAdditionalGenerationConditionProcedure.execute(world, x, y, z))
					continue;
