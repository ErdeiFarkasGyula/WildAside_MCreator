...
public class SubstiliumMushroomStr28Feature extends Feature<NoneFeatureConfiguration> {
	public static SubstiliumMushroomStr28Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new SubstiliumMushroomStr28Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:substilium_mushroom_str_28", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:substilium_mushroom_str_28", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public SubstiliumMushroomStr28Feature() {
