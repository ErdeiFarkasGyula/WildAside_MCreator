...
public class SubstiliumMushroomStr567Feature extends Feature<NoneFeatureConfiguration> {
	public static SubstiliumMushroomStr567Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new SubstiliumMushroomStr567Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:substilium_mushroom_str_567", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:substilium_mushroom_str_567", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public SubstiliumMushroomStr567Feature() {
