...
public class SubstiliumMushroomStr220Feature extends Feature<NoneFeatureConfiguration> {
	public static SubstiliumMushroomStr220Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new SubstiliumMushroomStr220Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:substilium_mushroom_str_220", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:substilium_mushroom_str_220", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public SubstiliumMushroomStr220Feature() {
