...
public class NaturalSporeBlasterStr41Feature extends Feature<NoneFeatureConfiguration> {
	public static NaturalSporeBlasterStr41Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new NaturalSporeBlasterStr41Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:natural_spore_blaster_str_41", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:natural_spore_blaster_str_41", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public NaturalSporeBlasterStr41Feature() {
