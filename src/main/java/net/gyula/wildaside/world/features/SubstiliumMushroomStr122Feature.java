...
public class SubstiliumMushroomStr122Feature extends Feature<NoneFeatureConfiguration> {
	public static SubstiliumMushroomStr122Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new SubstiliumMushroomStr122Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:substilium_mushroom_str_122", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:substilium_mushroom_str_122", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public SubstiliumMushroomStr122Feature() {
