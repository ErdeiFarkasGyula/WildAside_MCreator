...
public class HangingVibrionGelGrowerStr3Feature extends Feature<NoneFeatureConfiguration> {
	public static HangingVibrionGelGrowerStr3Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new HangingVibrionGelGrowerStr3Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:hanging_vibrion_gel_grower_str_3", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:hanging_vibrion_gel_grower_str_3", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public HangingVibrionGelGrowerStr3Feature() {
