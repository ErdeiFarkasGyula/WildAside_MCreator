...
public class SubstiliumMushroomStr417Feature extends Feature<NoneFeatureConfiguration> {
	public static SubstiliumMushroomStr417Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new SubstiliumMushroomStr417Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:substilium_mushroom_str_417", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:substilium_mushroom_str_417", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public SubstiliumMushroomStr417Feature() {
