...
public class NaturalSporeBlasterStr47Feature extends Feature<NoneFeatureConfiguration> {
	public static NaturalSporeBlasterStr47Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new NaturalSporeBlasterStr47Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:natural_spore_blaster_str_47", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:natural_spore_blaster_str_47", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public NaturalSporeBlasterStr47Feature() {
