...
public class HangingVibrionGelGrowerStr10Feature extends Feature<NoneFeatureConfiguration> {
	public static HangingVibrionGelGrowerStr10Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new HangingVibrionGelGrowerStr10Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:hanging_vibrion_gel_grower_str_10", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:hanging_vibrion_gel_grower_str_10", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public HangingVibrionGelGrowerStr10Feature() {
