...
public class NaturalSporeBlasterStr26Feature extends Feature<NoneFeatureConfiguration> {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:natural_spore_blaster_str_26", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:natural_spore_blaster_str_26", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
