...
public class HangingVibrionVinesGrowerStr15Feature extends Feature<NoneFeatureConfiguration> {
	public static HangingVibrionVinesGrowerStr15Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new HangingVibrionVinesGrowerStr15Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("wildaside:hanging_vibrion_vines_grower_str_15", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("wildaside:hanging_vibrion_vines_grower_str_15", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public HangingVibrionVinesGrowerStr15Feature() {
