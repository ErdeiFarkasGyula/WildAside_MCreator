...
public class HickoryForestBiome {
	public static final List<Climate.ParameterPoint> PARAMETER_POINTS = List.of(
			new Climate.ParameterPoint(Climate.Parameter.span(-0.35f, 0.5f), Climate.Parameter.span(-0.35f, 0.5f), Climate.Parameter.span(0.1f, 1f), Climate.Parameter.span(-1f, 0.35f), Climate.Parameter.point(0.0f),
					Climate.Parameter.span(-0.7f, 0.35f), 0),
			new Climate.ParameterPoint(Climate.Parameter.span(-0.35f, 0.5f), Climate.Parameter.span(-0.35f, 0.5f), Climate.Parameter.span(0.1f, 1f), Climate.Parameter.span(-1f, 0.35f), Climate.Parameter.point(1.0f),
					Climate.Parameter.span(-0.7f, 0.35f), 0));
	...
	public static Biome createBiome() {
		...
		return new Biome.BiomeBuilder().precipitation(Biome.Precipitation.RAIN).biomeCategory(Biome.BiomeCategory.NONE).temperature(0.4f).downfall(0.4f).specialEffects(effects).mobSpawnSettings(mobSpawnInfo.build())
