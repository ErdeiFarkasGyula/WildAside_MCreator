...
public class Modelentorium_gauntlet<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition gaunletRight = partdefinition.addOrReplaceChild(
				"gaunletRight", CubeListBuilder.create().texOffs(0, 0).addBox(-8.5F, -17.0F, -2.5F, 5.0F, 6.0F, 5.0F, new CubeDeformation(0.0F))
						.texOffs(0, 0).addBox(-8.75F, -12.0F, -1.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition gaunletLeft = partdefinition.addOrReplaceChild("gaunletLeft",
				CubeListBuilder.create().texOffs(0, 0).addBox(-8.5F, -17.0F, -2.5F, 5.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
