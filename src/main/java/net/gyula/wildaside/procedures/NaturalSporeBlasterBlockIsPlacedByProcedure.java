...
public class NaturalSporeBlasterBlockIsPlacedByProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		double gen_dis2 = 0;
		NaturalSporeBlasterBlockDestroyedByExplosionProcedure.execute(world, x, y, z);
		for (int index0 = 0; index0 < (int) (Mth.nextInt(new Random(), 8, 15)); index0++) {
		...
		for (int index1 = 0; index1 < (int) (Mth.nextInt(new Random(), 8, 15)); index1++) {
			gen_dis2 = gen_dis2 - 1;
			if (world.isEmptyBlock(new BlockPos(x + (new Object() {
				public Direction getDirection(BlockPos pos) {
					BlockState _bs = world.getBlockState(pos);
