...
public class NextPageProcProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if (WildasideModVariables.WorldVariables.get(world).allPages > (entity.getCapability(WildasideModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				.orElse(new WildasideModVariables.PlayerVariables())).currentPage) {
			{
				double _setval = (entity.getCapability(WildasideModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				...
				entity.getCapability(WildasideModVariables.PLAYER_VARIABLES_CAPABILITY, null).ifPresent(capability -> {
					capability.currentPage = _setval;
