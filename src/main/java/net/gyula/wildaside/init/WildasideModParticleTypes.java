...
public class WildasideModParticleTypes {
	...
	public static final RegistryObject<ParticleType<?>> ENTORIUM_PARTICLE = REGISTRY.register("entorium_particle",
			() -> new SimpleParticleType(true));
	public static final RegistryObject<ParticleType<?>> SUBSTILIUM_PARTICLE = REGISTRY.register("substilium_particle",
	...
	public static final RegistryObject<ParticleType<?>> STILL_SUBSTILIUM_PARTICLE = REGISTRY.register("still_substilium_particle",
			() -> new SimpleParticleType(false));
	public static final RegistryObject<ParticleType<?>> LIT_ENTORIUM_PARTICLE = REGISTRY.register("lit_entorium_particle",
			() -> new SimpleParticleType(true));
}
