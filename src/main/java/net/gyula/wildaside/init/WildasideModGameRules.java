...
public class WildasideModGameRules {
	public static final GameRules.Key<GameRules.BooleanValue> MUTEVIBRIONGROWTHS = GameRules.register("muteVibrionGrowths", GameRules.Category.PLAYER, GameRules.BooleanValue.create(false));
