...
public class WildasideModItems {
	...
	public static final RegistryObject<Item> VIBRION_ROOTS = block(WildasideModBlocks.VIBRION_ROOTS, CreativeModeTab.TAB_DECORATIONS);
	public static final RegistryObject<Item> SUBSTILIUM_SPROUTS = block(WildasideModBlocks.SUBSTILIUM_SPROUTS, CreativeModeTab.TAB_DECORATIONS);
